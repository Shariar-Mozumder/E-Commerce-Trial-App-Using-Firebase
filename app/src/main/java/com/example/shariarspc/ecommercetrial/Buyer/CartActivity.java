...
public class CartActivity extends AppCompatActivity {
    ...
    TextView total_amount,msg1;
    private Button button_next;

    private int totalpriceamount=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        total_amount=findViewById(R.id.total_amount_TV);
        button_next=findViewById(R.id.next_btn);

        button_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(CartActivity.this, ConfirmFinalOrderActivity.class);
                intent.putExtra("total amount",totalpriceamount);
    ...
    protected void onStart() {
       ...
       final DatabaseReference cartref= FirebaseDatabase.getInstance().getReference().child("Cart List");
        ...
        FirebaseRecyclerOptions<Cart> options=new FirebaseRecyclerOptions.Builder<Cart>().setQuery(cartref
        .child("User View").child(Prevelent.currentOnlineUsers.getPhone()).child("Products")
        ,Cart.class).build();
        ...
        FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter=new FirebaseRecyclerAdapter<Cart, CartViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull CartViewHolder cartViewHolder, int i, @NonNull final Cart cart) {
                ...
                cartViewHolder.txtProductPrice.setText("Price: "+cart.getPprice()+"BDT");

               int individualproductTotalprice=((Integer.valueOf(cart.getPprice())))*Integer.valueOf(cart.getQuantity());
               totalpriceamount=totalpriceamount+individualproductTotalprice;

                total_amount.setText("Total Amount= "+ totalpriceamount+" BDT");
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if(i==1){
                                    cartref.child("User View").child(Prevelent.currentOnlineUsers.getPhone())
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(shipmentState.equals("shipped")){
                        ...
                        total_amount.setText("Dear "+username+",\nYour orders are shipped successfully! ");
                        recyclerView.setVisibility(View.GONE);
                        msg1.setVisibility(View.VISIBLE);
                        button_next.setVisibility(View.GONE);
                    }
                    else if(shipmentState.equals("not shipped")){
                        total_amount.setText("Shipping Status : Not Shipped ");
                        recyclerView.setVisibility(View.GONE);
                        msg1.setVisibility(View.VISIBLE);
                        button_next.setVisibility(View.GONE);
                    }
